...
///
/// The [VoiceControllerEx] class provides functionality for playing, pausing, stopping, and seeking voice playback.
...
/// );
///
class VoiceControllerEx extends MyTicker {
  ...
  /// Creates a new [VoiceControllerEx] instance.
  VoiceControllerEx({
